...
class ArrayOperation
{
    ...
    int FindOccurance(int element)
    {
        int first = FindFirst(element);
...
class BinarySearch5
{
    public static void main(String A[])
    {
        ...
        Result = aobj.FindOccurance(element);
        ...
        {
            System.out.println("Element is present in array : "+Result+" times");
        }
